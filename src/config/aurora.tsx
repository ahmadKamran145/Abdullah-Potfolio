...
export default function Aurora(props: AuroraProps) {
    ...
    useEffect(() => {
        ...
        if (!ctn || isLowPowerMode) return;

        // Quality-based rendering settings
        const qualitySettings = {
            low: { antialias: false, alpha: true },
            medium: { antialias: true, alpha: true },
            high: { antialias: true, alpha: true },
        };

        const renderer = new Renderer({
            alpha: qualitySettings[quality].alpha,
            premultipliedAlpha: true,
            antialias: qualitySettings[quality].antialias,
        });
